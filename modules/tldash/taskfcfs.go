...
func taskfcfs(wg *sync.WaitGroup, userData loader.UserDataStruct, id int, password string, solveIp string, task taskStruct, bypass bool) {
	...
	if bypass {
		fmt.Println(colors.TaskPrefix(id) + colors.Yellow("Attempting Bypass..."))
	}
